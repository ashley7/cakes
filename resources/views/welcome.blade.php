        ...
        <div class="banner-wrap">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 banner-right text-right wow fadeInUp" data-wow-delay="0.3s">
                        <div class="img-jump">
    ...
    <section class="section pb-minus-70" id="services" data-scroll-index="2">
            ...
            <div class="tab-content-wrap">
                <div class="tab-content-item wow active">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-1 col-lg-6">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-6 features-tab-image">
                            <center>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-4 col-sm-12 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="services-item">
