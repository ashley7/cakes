...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
      ...
      $mail_content     = "<h2>From</h2><p>{$contact_email}</p><h2>Name</h2><p>{$contact_name}</p><h2>Subject</h2><p>{$contact_subject}</p><h2>Message</h2><p>{$contact_message}</p>";
      ...
      $smtp_password    = 'yoursmtpuserpassword';              // SMTP password
